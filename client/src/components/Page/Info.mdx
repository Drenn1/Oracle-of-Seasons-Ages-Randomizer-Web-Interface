...
- More detailed notes for {ngLink("ages", "doc/ages_notes.md")} and {ngLink("seasons", "doc/seasons_notes.md")}.
- The [changelog](https://github.com/Stewmath/oracles-randomizer-ng/blob/master/CHANGELOG) for oracles-randomizer-ng.
- {ngLink("A comparison of jangler's randomizer with oracles-randomizer-ng", "/doc/ng_differences.md")}.
